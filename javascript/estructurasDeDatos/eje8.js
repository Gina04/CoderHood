...
atributo booleano agotado en true si el stock es mayor a 0, caso contrario false.
...
function esStockMayorA(producto){
    return producto.stock > 0
}

function agregarAtributo(producto){
    if(producto.stock > 0){
...
let situacionStock = productos.map(agregarAtributo)

console.log(situacionStock)